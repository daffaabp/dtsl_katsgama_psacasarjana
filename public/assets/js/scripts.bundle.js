...
var KTUtil = function() {
    ...
    return {
        ...
        setHTML: function(e, t) {
            while (e.firstChild) e.removeChild(e.firstChild); // Bersihkan isi elemen

            const template = document.createElement("template"); // Template tidak dirender langsung
            template.innerHTML = t.trim(); // Masukkan HTML ke template
          
            e.appendChild(template.content.cloneNode(true)); // Sisipkan ke elemen target
        },
        getHTML: function(e) {
