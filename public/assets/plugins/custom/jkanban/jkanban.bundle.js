        ...
        ! function() {
            this.jKanban = function() {
                ...
                arguments[0] && "object" == typeof arguments[0] && (this.options = function(e, t) {
                    ...
                    var container = e.element.querySelector('[data-id="' + t + '"] .kanban-drag');
                    var item = document.createElement("div");
                
                    item.classList.add("kanban-item");
                
                    // Tambahkan ID jika tersedia
                    if (typeof n.id !== "undefined" && n.id !== "") {
                        item.setAttribute("data-eid", n.id);
                    }
                
                    // Tambahkan class tambahan jika ada
                    if (n.class && Array.isArray(n.class)) {
                        n.class.forEach(function(cls) {
                            item.classList.add(cls);
                        });
                    }
                
                    // Sanitize title untuk mencegah XSS
                    ...
                    item.dragfn = n.drag;
                    item.dragendfn = n.dragend;
                    item.dropfn = n.drop;
                
                    // Function tambahan khusus sistem Anda (misalnya `c()` dan `r()`)
                    c(item, n);
                    r(item);
                
                    // Ubah cursor jika fitur drag handle diaktifkan
                    if (e.options.itemHandleOptions.enabled) {
                    ...
                    var i = e.options.itemAddOptions.enabled,
                        ...
                        for (var f in t) {
                            ...
                            // Tambahkan ke board jika belum ada
                            if (!n) {
                                e.options.boards.push(p);
                            }
                        
                            // Atur lebar container jika non-responsive
                            if (!e.options.responsivePercentage) {
                                var baseWidth = parseInt(o) + 2 * parseInt(e.options.gutter);
                                if (e.container.style.width === "") {
                                    e.container.style.width = baseWidth + "px";
                                } else {
                                    e.container.style.width = parseInt(e.container.style.width) + baseWidth + "px";
                                }
                            }
                        
                            // Buat elemen board utama
                            var m = document.createElement("div");
                            m.dataset.id = p.id;
                            m.dataset.order = e.container.childNodes.length + 1;
                            m.classList.add("kanban-board");
                            m.style.width = e.options.responsivePercentage ? o + "%" : o;
                            ...
                            var headerClasses = (p.class || "").split(",");
                            ...
                            var bodyClasses = (p.bodyClass || "").split(",");
                            ...
                            for (var y in p.item) {
                                ...
                                if (w.id) E.dataset.eid = w.id;
                        
                                if (Array.isArray(w.class)) {
                                ...
                                c(E, w); // fungsi tambahan (mungkin handler/event binding)
                                r(E);
                            ...
                            if (i) { // Jika tombol tambah diaktifkan
                                ...
                                a(C, p.id); // fungsi tambahan (mungkin event handler)
                            }
                ...
                function s(e, t, n) {
                    var o = function(e, t, n) {
                        ...
                        for (o = 0; o < c.length; o++)
                            if ((i = c[o]).element === e && i.type === t && i.fn === n) return o
                    }(e, t, n);
                    if (o) {
                        var i = c[o].wrapper;
        ...
        (function(n) {
            (function() {
                ...
                t.exports = function(e, t) {
                                    ...
                                    T = y("pageX", e) - f.left, C = y("pageY", e) - f.top, r.add(L || E, "gu-transit"),
                                        function() {
                                            if (!n) {
                                                ...
                                                (n = E.cloneNode(!0)).style.width = m(e) + "px", n.style.height = v(e) + "px", r.rm(n, "gu-transit"), r.add(n, "gu-mirror"), A.mirrorContainer.appendChild(n), c(d, "add", "mousemove", Q), r.add(A.mirrorContainer, "gu-unselectable"), _.emit("cloned", n, E, "mirror")
                                            }
                                        }(), Q(e)
                                }
                            } else K({})
                    ...
                    function V() {
                        var e = L || E;
                        U(), n && (r.rm(A.mirrorContainer, "gu-unselectable"), c(d, "remove", "mousemove", Q), h(n).removeChild(n), n = null), e && r.rm(e, "gu-transit"), B && clearTimeout(B), _.dragging = !1, I && _.emit("out", e, I, w), _.emit("dragend", e), w = E = L = S = x = B = I = null
                    }
                    ...
                    function ee(e, t, n, o) {
                        ...
                        return t !== e ? (i = t.getBoundingClientRect(), function(e) {
                            return e ? b(t) : t
                        }(r ? n > i.left + m(i) / 2 : o > i.top + v(i) / 2)) : function() {
                            var t, i, a, d = e.children.length;
                            for (t = 0; t < d; t++) {
