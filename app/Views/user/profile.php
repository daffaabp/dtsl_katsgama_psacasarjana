            ...
            <div class="card-body border-top p-9">
                ...
                <div class="notice rounded border-warning border border-dashed mb-9 p-6">
                    ...
                    <div class="row mb-6" x-data="{show:false}">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input @click.prevent="show=true" x-show="!show" type="text" name="s2_prodi" class="form-control form-control-lg form-control-solid" placeholder="" value="<?= old('s2_prodi', isset($S2['prodi']) ? $S2['prodi'] : '') ?>" />
                            <div x-show="show">
                ...
                <div class="notice  rounded border-warning border border-dashed mb-9 p-6">
                    ...
                    <div class="row mb-6" x-data="{show:false}">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input @click="show=true" x-show="!show" type="text" name="s3_prodi" class="form-control form-control-lg form-control-solid" placeholder="" value="<?= old('s3_prodi', (isset($S3['prodi'])) ? $S3['prodi'] : '') ?>" />
                            <div x-show="show">
