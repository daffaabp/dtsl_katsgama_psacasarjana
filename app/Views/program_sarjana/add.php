            ...
            <div class="card-body border-top p-9">
                ...
                <div class="notice  rounded border-warning border border-dashed mb-9 p-6">
                    ...
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="s1_universitas" class="form-control form-control-lg form-control-solid" placeholder="" value="" />
                    ...
                    <div class="row mb-6">
                        <!--begin::Label-->
                        <label class="col-lg-4 col-form-label  fw-semibold fs-6">Prodi / Minat</label>
                        <!--end::Label-->
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="s1_prodi" class="form-control form-control-lg form-control-solid" placeholder="" value="" />
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Input group-->
                ...
                <div class="notice rounded border-warning border border-dashed mb-9 p-6">
                    ...
                    <div class="row mb-6">
                        <!--begin::Label-->
                        <label class="col-lg-4 col-form-label fw-semibold fs-6">Prodi S2 UGM</label>
                        <!--end::Label-->
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <div>
                                <select name="s2_prodi_alt" aria-label="Select a prodi" data-control="select2" data-placeholder="Pilih Prodi..." class="form-select form-select-solid form-select-lg fw-semibold">
                                    <option value="">Prodi UGM</option>
                                    <?php foreach ($prodi_s2 as $prd) : ?>
                                        <option value="<?= $prd['nprodi'] ?>"><?= $prd['nprodi'] ?></option>
                                    <?php endforeach; ?>
                                    <option value="-">Prodi Lainya</option>
                                </select>
                            </div>
                        </div>
                        <!--end::Col-->
                    ...
                    <div class="row mb-6">
                        <!--begin::Label-->
                        <label class="col-lg-4 col-form-label fw-semibold fs-6">Prodi Lainya</label>
                        <!--end::Label-->
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                ...
                <div class="notice  rounded border-warning border border-dashed mb-9 p-6">
                    ...
                    <div class="row mb-6">
                        <!--begin::Label-->
                        <label class="col-lg-4 col-form-label fw-semibold fs-6">Prodi S3 UGM</label>
                        <!--end::Label-->
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <div>
                                <select name="s3_prodi_alt" aria-label="Select a prodi" data-control="select2" data-placeholder="Pilih Prodi..." class="form-select form-select-solid form-select-lg fw-semibold">
                                    <option value="">Pilih Prodi</option>
                                    <?php foreach ($prodi_s3 as $prd) : ?>
                                        <option value="<?= $prd['nprodi'] ?>"><?= $prd['nprodi'] ?></option>
                                    <?php endforeach; ?>
                                    <option value="-">Prodi Lainya</option>
                                </select>
...
<script>
    document.addEventListener('alpine:init', () => {
        ...
        $(addForm.querySelector('[name="s2_prodi_alt"]')).on('change', function() {
            var s2_prodi = addForm.querySelector('[name="s2_prodi_alt"]').value;
            addForm.querySelector('[name="s2_prodi"]').value = s2_prodi;
        });
        $(addForm.querySelector('[name="s3_prodi_alt"]')).on('change', function() {
            var s3_prodi = addForm.querySelector('[name="s3_prodi_alt"]').value;
            addForm.querySelector('[name="s3_prodi"]').value = s3_prodi;
        });
        ...
        Alpine.data('ui', () => ({
            async handleSubmit() {
                ...
                if (status == 'Valid') {
                    var s2_universitas = addForm.querySelector('[name="s2_universitas"]');
                    var s3_universitas = addForm.querySelector('[name="s3_universitas"]');
                    if ((!s2_universitas.value && !s3_universitas.value)) {
                        Swal.fire({
                            text: "Riwayat Akademik S2/S3 harus diisi",
                            icon: "error",
